...
//import Controlador.Controlador_Shell;
import Controlador.Controlador_Shell;
import Modelo.Hilo_Shell;
import Modelo.Shell;
 ...
 * @author Kevin Meza
 */
public class Ventana_Shell extends javax.swing.JFrame {

    /**
     * Creates new form Ventana
     */
    FRM_InformacionShell ventana;
    ...
    */
    Hilo_Shell hilo;
    Controlador_Shell controlador;
    public Ventana_Shell() {
        initComponents();
        setVisible(false);
        ventana=new FRM_InformacionShell();
        hilo= new Hilo_Shell(this);
        controlador= new Controlador_Shell(this);
    ...
    */
    ...
    public void ingresarDatos_Algoritmo(int[] arreglo) throws InterruptedException {
       ...
       Shell.ordenacionShell(numeros,botonesArb);
       Shell.imprimir(numeros);
    ...
    */
    ...
    private void initComponents() {
        ...
        btnAr_Volver.setActionCommand("Volver al Inicio Shell");
        getContentPane().add(btnAr_Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 94, 269, 44));
        ...
        getContentPane().add(btn_MostrarInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 120, -1, -1));
...
//            java.util.logging.Logger.getLogger(Ventana_Shell.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Ventana_Shell().setVisible(true);
//            }
//        });
//    }
