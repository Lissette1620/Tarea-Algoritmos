...
import Controlador.Controlador_Intercambiar;
import Modelo.Hilo_Intercambiar;
import Modelo.Intercambiar;
 ...
 * @author Kevin Meza
 */
public class Ventana_Intercambiar extends javax.swing.JFrame {

    /**
     * Creates new form Ventana
     */
    FRM_InformacionIntercambiar ventana;
    ...
    */
    Controlador_Intercambiar controlador;
    
    Hilo_Intercambiar hilo;
    public Ventana_Intercambiar() {
        
        initComponents();
        setVisible(false);
        hilo= new Hilo_Intercambiar(this);
        controlador= new Controlador_Intercambiar(this);
        this.btnAr_Volver.addActionListener(controlador);
        ventana=new FRM_InformacionIntercambiar();
    }
    ...
    */
    ...
    public void ingresarDatos_Algoritmo(int[] arreglo) throws InterruptedException {
       ...
       Intercambiar.ordIntercambio(numeros,botonesArb);
       Intercambiar.imprimir(numeros);
    ...
    */
    ...
    private void initComponents() {
        ...
        btnAr_Volver.setSelected(true);
        btnAr_Volver.setText("Volver al Inicio");
        btnAr_Volver.setActionCommand("Volver al Inicio Intercambiar");
        getContentPane().add(btnAr_Volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(276, 106, 226, 44));
        ...
        btn_MostrarInfo.setText("Mostrar Informacion");
        btn_MostrarInfo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_MostrarInfoActionPerformed(evt);
            }
        });
        getContentPane().add(btn_MostrarInfo, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 140, -1, -1));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/orig_64506.jpg"))); // NOI18N
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 810, 190));
...
//            java.util.logging.Logger.getLogger(Ventana_Intercambiar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new Ventana_Intercambiar().setVisible(true);
//            }
//        });
//    }
